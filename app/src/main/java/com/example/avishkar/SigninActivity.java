...
import com.example.avishkar.databinding.ActivitySigninBinding;
...
database = FirebaseDatabase.getInstance();
        pro = new ProgressDialog(SigninActivity.this);
        pro.setTitle("Login");
        pro.setMessage("logging in to your account ");
            ...
            public void onClick(View view) {
                ...
                auth.signInWithEmailAndPassword(binding.etemail.getText().toString(),binding.etpass.getText().toString()).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        {
                            Intent intent=new Intent(SigninActivity.this,MainActivitypage.class);
